...
_This repository is used to create **OKD 3.11 Clusters** with **10** simple steps on **Bare VM's**_
...
#To access URL from your local system we need to configure master host in C:\Windows\System32\drivers\etc\hosts (Windows) or ~/etc/hosts (MacOS) file as below
